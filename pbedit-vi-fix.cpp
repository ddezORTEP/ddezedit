...
private:
    ...
    void initColors() {
        init_pair(LINE_NUMBER_COLOR, COLOR_BLUE, COLOR_BLACK);
        init_pair(STATUS_BAR_COLOR, COLOR_GREEN, COLOR_BLACK);
